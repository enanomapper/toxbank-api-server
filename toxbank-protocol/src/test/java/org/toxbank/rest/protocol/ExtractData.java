...
/**
 * An utility to generate dump of the database in DbUnit format, to be used in
 * tests
 * 
 * @author nina
 * 
...
public class ExtractData extends DbUnitTest {
	...
	protected void extract() throws Exception {
		...
		try {
			...
			FlatDtdDataSet
					.write(partialDataSet,
							new FileOutputStream(
									"src/test/resources/org/toxbank/protocol/partial-dataset.dtd"));
			FlatXmlDataSet
					.write(partialDataSet,
							new FileOutputStream(
									"src/test/resources/org/toxbank/protocol/partial-dataset.xml"));
